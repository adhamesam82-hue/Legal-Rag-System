...
export const en: Catalog = {
  ...
  "@legalos.matters.field.staff": { defaultMessage: "Case team" },
  "@legalos.matters.field.staffHint": { defaultMessage: "Everyone who may log time, take tasks or attend hearings on this case." },
  "@legalos.matters.dialog.selectStaff": { defaultMessage: "No one else yet" },
  "@legalos.matters.dialog.searchLawyer": { defaultMessage: "Search by name…" },
  ...
  "@legalos.matters.detail.tasks.newTask": { defaultMessage: "New task" },
  "@legalos.matters.detail.tasks.titleLabel": { defaultMessage: "What needs doing" },
  "@legalos.matters.detail.tasks.assigneeLabel": { defaultMessage: "Assigned to" },
  "@legalos.matters.detail.tasks.dueLabel": { defaultMessage: "Due" },
  "@legalos.matters.detail.tasks.priorityLabel": { defaultMessage: "Priority" },
  "@legalos.matters.detail.tasks.create": { defaultMessage: "Add task" },
  ...
  "@legalos.matters.detail.tasks.emptyDescription": {
    defaultMessage: "Add the first task on this case from the button above.",
  },
...
export const ar: Catalog = {
  ...
  "@legalos.matters.field.staff": { defaultMessage: "فريق القضية" },
  "@legalos.matters.field.staffHint": { defaultMessage: "كل من يجوز له تسجيل وقت أو تولّي مهمة أو حضور جلسة في هذه القضية." },
  "@legalos.matters.dialog.selectStaff": { defaultMessage: "لا أحد بعد" },
  "@legalos.matters.dialog.searchLawyer": { defaultMessage: "ابحث بالاسم…" },
  ...
  "@legalos.matters.list.search.placeholder": {
    defaultMessage: "ابحث باسم القضية أو الموكّل",
  },
  ...
  "@legalos.matters.detail.tasks.newTask": { defaultMessage: "مهمة جديدة" },
  "@legalos.matters.detail.tasks.titleLabel": { defaultMessage: "المطلوب عمله" },
  "@legalos.matters.detail.tasks.assigneeLabel": { defaultMessage: "مسندة إلى" },
  "@legalos.matters.detail.tasks.dueLabel": { defaultMessage: "تاريخ الاستحقاق" },
  "@legalos.matters.detail.tasks.priorityLabel": { defaultMessage: "الأولوية" },
  "@legalos.matters.detail.tasks.create": { defaultMessage: "إضافة المهمة" },
  ...
  "@legalos.matters.detail.tasks.emptyDescription": {
    defaultMessage: "أضف أول مهمة على هذه القضية من الزر أعلاه.",
  },
