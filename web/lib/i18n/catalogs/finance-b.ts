...
export const ar: Catalog = {
  ...
  "@legalos.accounting.banner.description": {
    defaultMessage:
      "لا يوجد نموذج بيانات فعلي خلف هذا القسم بعد. كل رقم أدناه محتوى تجريبي وليس بيانات فعلية من سجلات مكتبك. أما الموكّلين والقضايا والجلسات والمستندات والمهام وتتبع الوقت والفوترة فهي وظائف فعلية ومتصلة بالنظام.",
  },
