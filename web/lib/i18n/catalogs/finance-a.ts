...
export const en: Catalog = {
  ...
  "@legalos.billing.create.title": { defaultMessage: "New invoice" },
  "@legalos.billing.create.clientLabel": { defaultMessage: "Client" },
  "@legalos.billing.create.clientPlaceholder": { defaultMessage: "Select a client" },
  "@legalos.billing.create.matterLabel": { defaultMessage: "Matter" },
  "@legalos.billing.create.matterPlaceholder": { defaultMessage: "Select a matter (optional)" },
  "@legalos.billing.create.matterPlaceholderNoClient": { defaultMessage: "Choose a client first" },
  "@legalos.billing.create.issuedLabel": { defaultMessage: "Issued" },
  "@legalos.billing.create.dueLabel": { defaultMessage: "Due" },
  "@legalos.billing.create.numberLabel": { defaultMessage: "Invoice number" },
  "@legalos.billing.create.numberPlaceholder": { defaultMessage: "Leave blank" },
  "@legalos.billing.create.numberHint": { defaultMessage: "Will be generated automatically" },
  "@legalos.billing.create.linesHeading": { defaultMessage: "Line items" },
  "@legalos.billing.create.line.descriptionPlaceholder": { defaultMessage: "Description" },
  "@legalos.billing.create.line.quantity": { defaultMessage: "Qty" },
  "@legalos.billing.create.line.unitAmount": { defaultMessage: "Unit price" },
  "@legalos.billing.create.line.taxPercent": { defaultMessage: "Tax %" },
  "@legalos.billing.create.line.total": { defaultMessage: "Total" },
  "@legalos.billing.create.line.add": { defaultMessage: "Add a line" },
  "@legalos.billing.create.line.remove": { defaultMessage: "Remove line" },
  "@legalos.billing.create.tax": { defaultMessage: "Tax" },
  "@legalos.billing.create.notesLabel": { defaultMessage: "Notes" },
  "@legalos.billing.create.notesPlaceholder": {
    defaultMessage: "Payment terms, bank account, any note that appears under the invoice",
  },
  "@legalos.billing.create.cancel": { defaultMessage: "Cancel" },
  "@legalos.billing.create.saving": { defaultMessage: "Saving..." },
  "@legalos.billing.create.save": { defaultMessage: "Save invoice" },
  "@legalos.billing.create.error": { defaultMessage: "Could not save this invoice." },
  "@legalos.billing.create.numberConflict": {
    defaultMessage:
      "That invoice number is already in use. Leave the field blank to have one generated automatically.",
  },
};
...
export const ar: Catalog = {
  ...
  "@legalos.billing.create.title": { defaultMessage: "فاتورة جديدة" },
  "@legalos.billing.create.clientLabel": { defaultMessage: "الموكّل" },
  "@legalos.billing.create.clientPlaceholder": { defaultMessage: "اختر موكّلًا" },
  "@legalos.billing.create.matterLabel": { defaultMessage: "القضية" },
  "@legalos.billing.create.matterPlaceholder": { defaultMessage: "اختر قضية (اختياري)" },
  "@legalos.billing.create.matterPlaceholderNoClient": { defaultMessage: "اختر موكّلًا أولًا" },
  "@legalos.billing.create.issuedLabel": { defaultMessage: "تاريخ الإصدار" },
  "@legalos.billing.create.dueLabel": { defaultMessage: "تاريخ الاستحقاق" },
  "@legalos.billing.create.numberLabel": { defaultMessage: "رقم الفاتورة" },
  "@legalos.billing.create.numberPlaceholder": { defaultMessage: "اتركه فارغًا" },
  "@legalos.billing.create.numberHint": { defaultMessage: "سيُولَّد تلقائيًا" },
  "@legalos.billing.create.linesHeading": { defaultMessage: "بنود الفاتورة" },
  "@legalos.billing.create.line.descriptionPlaceholder": { defaultMessage: "البيان" },
  "@legalos.billing.create.line.quantity": { defaultMessage: "الكمية" },
  "@legalos.billing.create.line.unitAmount": { defaultMessage: "سعر الوحدة" },
  "@legalos.billing.create.line.taxPercent": { defaultMessage: "الضريبة ٪" },
  "@legalos.billing.create.line.total": { defaultMessage: "الإجمالي" },
  "@legalos.billing.create.line.add": { defaultMessage: "إضافة بند" },
  "@legalos.billing.create.line.remove": { defaultMessage: "حذف البند" },
  "@legalos.billing.create.tax": { defaultMessage: "الضريبة" },
  "@legalos.billing.create.notesLabel": { defaultMessage: "ملاحظات" },
  "@legalos.billing.create.notesPlaceholder": {
    defaultMessage: "شروط السداد، رقم الحساب البنكي، أي بيان يظهر أسفل الفاتورة",
  },
  "@legalos.billing.create.cancel": { defaultMessage: "إلغاء" },
  "@legalos.billing.create.saving": { defaultMessage: "جارٍ الحفظ..." },
  "@legalos.billing.create.save": { defaultMessage: "حفظ الفاتورة" },
  "@legalos.billing.create.error": { defaultMessage: "تعذّر حفظ هذه الفاتورة." },
  "@legalos.billing.create.numberConflict": {
    defaultMessage: "رقم الفاتورة هذا مستخدَم بالفعل. اترك الحقل فارغًا ليُولَّد رقم تلقائيًا.",
  },
};
