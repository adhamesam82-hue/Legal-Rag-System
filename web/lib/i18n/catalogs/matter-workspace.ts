...
export const ar: Catalog = {
  ...
  "@legalos.matterWorkspace.financial.clientFunds": {
    defaultMessage: "أموال العميل (القضية)",
  },
  "@legalos.matterWorkspace.financial.clientFunds.hint": {
  ...
  "@legalos.matterWorkspace.conflicts.terms.hint": {
    defaultMessage: "يبحث في عملاء المكتب وأطراف القضايا والخصوم ومحاميهم.",
  },
  ...
  "@legalos.matterWorkspace.comms.logs.emptyDescription": {
    defaultMessage:
      "سجِّل المكالمات والرسائل والاجتماعات على هذه القضية ليبقى ما أُبلغ به العميل موثَّقًا.",
  },
  ...
  "@legalos.matterWorkspace.comms.portals.emptyDescription": {
    defaultMessage: "امنح جهة اتصال محدَّدة لدى العميل وصولًا لمستندات هذه القضية وفواتيرها ورسائلها.",
  },
