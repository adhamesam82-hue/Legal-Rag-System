...
const domains = [ai, astryx, clients, common, crm, documents, enums, financeA, financeB, knowledgeBase, matters, matterWorkspace, overview, practice, settings, shell, team];
