 ...
 * Generated: 2026-08-01T22:27:21.268Z
 */
...
export const legalosTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FFFFFF, #111C33)",
    "--color-background-body": "light-dark(#F8FAFC, #0B1220)",
    "--color-background-card": "light-dark(#FFFFFF, #111C33)",
    "--color-background-popover": "light-dark(#FFFFFF, #16203B)",
    "--color-background-muted": "light-dark(#151D190D, #151D1980)",
    "--color-accent": "light-dark(#006E45, #4DDEA4)",
    ...
    "--color-text-primary": "light-dark(#151D19, #DAE5DF)",
    "--color-text-secondary": "light-dark(#3B4A42, #9EAFA6)",
    "--color-text-disabled": "light-dark(#84948C, #53625A)",
    ...
    "--color-icon-primary": "light-dark(#151D19, #DAE5DF)",
    "--color-icon-secondary": "light-dark(#3B4A42, #9EAFA6)",
    ...
    "--color-border": "light-dark(#0F172A14, #F8FAFC1F)",
    "--color-border-emphasized": "light-dark(#0F172A26, #F8FAFC33)",
    ...
    "--color-background-inverted": "light-dark(#0F172A, #F8FAFC)",
    "--color-track": "light-dark(#9EAFA6, #3B4A42)",
    "--radius-chat": "35px"
  },
