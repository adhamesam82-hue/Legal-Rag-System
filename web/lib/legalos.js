 ...
 * Generated: 2026-09-05T02:50:59.168Z
 */
...
export const legalosTheme = {
  ...
  tokens: {
    ...
    "--accent": "light-dark(oklch(0.66 0.11 76), oklch(0.79 0.12 80))",
    "--accent-fg": "light-dark(#ffffff, oklch(0.2 0.04 80))",
    "--accent-soft": "light-dark(oklch(0.955 0.04 82), oklch(0.315 0.05 80))",
