...
MATTERS = [
    ...
    },
    {
        ...
        "matter_type": "family_personal_status",
        "status": "active",
        "responsible_user": AHMED,
        "staff": [],
...
DOCUMENTS = [
    ("nabil-v-nile-trading", "عقد التوزيع (الأصل الموقّع)", "contract", MONA, date(2025, 11, 5), 1_258_291, "final"),
    ("nabil-v-nile-trading", "مذكرة الدفاع — المسودة الثالثة", "brief", MONA, date(2026, 2, 15), 348_160, "filed"),
    ("nabil-v-nile-trading", "سجلات التسليم — الربع الثالث 2025", "evidence", LAYLA, date(2025, 12, 12), 90_112, "final"),
    ("nabil-v-nile-trading", "تقرير الخبير المحاسبي — نسخة معلّق عليها", "evidence", MONA, date(2026, 7, 16), 2_516_582, "under_review"),
    ("nabil-v-nile-trading", "مذكرة الاستئناف — مسودة", "brief", MONA, date(2026, 7, 28), 215_040, "draft"),
    ("nabil-v-nile-trading", "توكيل العميل", "poa", AHMED, date(2025, 11, 4), 153_600, "signed"),
    ("delta-foods-nda-review", "اتفاقية عدم الإفشاء المتبادلة — النسخة الموقّعة", "contract", YOUSSEF, date(2026, 6, 24), 419_840, "signed"),
    ("delta-foods-nda-review", "بيان الفروق مقارنةً بالنموذج المعتمد", "brief", YOUSSEF, date(2026, 6, 18), 97_280, "final"),
    ("delta-foods-labour-dispute", "إخطارات إنهاء الخدمة (7 مجمّعة)", "correspondence", LAYLA, date(2026, 7, 20), 696_320, "filed"),
    ("delta-foods-labour-dispute", "كشوف حساب مكافأة نهاية الخدمة", "evidence", YOUSSEF, date(2026, 7, 20), 122_880, "filed"),
    ("delta-foods-labour-dispute", "ملفات العاملين — تحت المراجعة", "evidence", LAYLA, date(2026, 7, 29), 5_347_737, "under_review"),
    ("khalil-tax-objection", "إخطار إعادة التقدير من مصلحة الضرائب", "correspondence", AHMED, date(2026, 5, 22), 307_200, "final"),
    ("khalil-tax-objection", "دراسة أسعار التحويل", "evidence", AHMED, date(2026, 6, 10), 1_887_437, "under_review"),
    ("al-amal-commercial-registration", "طلب تجديد الرخصة التجارية", "form", LAYLA, date(2026, 7, 1), 225_280, "draft"),
    ("el-sayed-estate-partition", "تقرير تقدير العقار", "evidence", AHMED, date(2026, 3, 11), 1_153_434, "final"),
    ("el-sayed-estate-partition", "إعلام الوراثة", "judgment", AHMED, date(2025, 9, 16), 97_280, "final"),
    ("zahran-contract-dispute", "عقد التوريد (الأصل)", "contract", MONA, date(2025, 8, 11), 552_960, "final"),
...
CUSTOM_FIELDS = [
    ...
    ("court_circuit", "الدائرة القضائية", "text", [], False, 3, "civil"),
